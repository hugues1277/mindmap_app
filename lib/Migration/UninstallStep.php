...
class UninstallStep implements IRepairStep {
    ...
    */
    public function run(IOutput $output) {
            ...
            $this->removeFromFile($mimetypealiasesFile, ['application/jm' => 'application-jm']);
            $this->removeFromFile($mimetypemappingFile, ['jm' => 'application/jm']);
            $this->logger->info("Remove .jm from mimetype list.", ["app" => "mindmap_app"]);
